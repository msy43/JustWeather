...
class AutoCompleteAdapter (private var citys: List<AutoCompleteElement>, val context: Context) :
    ...
    class ViewHolder(private val listBinding : ListDesingBinding) : RecyclerView.ViewHolder(listBinding.root){
        ...
        val sharedPreference: SharedPreferences = listBinding.root.context.getSharedPreferences("city",Context.MODE_PRIVATE)
